...
class Apartamentos {
    ...
    public void ordenaPorSelecao() {
        ...
        for (int externo = 0; externo < (this.qtdeAptos - 1); externo++) {
            ...
            for (interno = (externo + 1); interno < this.qtdeAptos; interno++) {
                if (apartamentos[interno].nome != apartamentos[indiceDoMenor].nome) {
    ...
    private void trocaAptos(int i, int indiceDoMenor) {
        Apartamento temp = this.apartamentos[i];
        this.apartamentos[i] = this.apartamentos[indiceDoMenor];
        this.apartamentos[indiceDoMenor] = temp;
    }
