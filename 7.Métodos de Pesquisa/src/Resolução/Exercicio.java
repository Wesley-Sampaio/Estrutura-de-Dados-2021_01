...
class Apartamentos {
    ...
    public Apartamento buscaBinaria(String nome) {
        ...
        while (inicio <= fim) {
            meio = (inicio + fim) / 2;
            if (nome.equals(this.apartamentos[meio].nome)) {
    ...
    public void ordenaNomesPorInsercao() {
        int interno, externo;
...
public class Exercicio {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            Apartamento aptoEncontrado = aptos.buscaBinaria(nome);
