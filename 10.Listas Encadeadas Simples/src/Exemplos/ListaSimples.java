...
class Apartamentos {
    ...
    public boolean excluiApartamento(int numero) {
        System.out.println("Você ainda não implementou o método de exclusão!");
    ...
    public Apartamento buscaLinear(int numero) {
        System.out.println ("Você ainda não implementou o método de busca!");
        
        return new Apartamento(0, "Você ainda não implementou o método de busca!", "0");
    }
